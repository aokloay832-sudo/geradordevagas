...
def gerar_vaga_groq(cv_text: str, cidade: str):
    prompt = f    prompt = f'''Você é um Headhunter e Especialista de Recrutamento Sênior da EQUIPE 520 VAGAS, focado em vagas executivas e estratégicas em diversos setores do mercado.
...
'''
        ...
        "temperature": 0.8,  # <--- Aumentar para 0.8 dá mais liberdade de variação para a IA
        "max_tokens": 2048
    }
