...
# Configurações de Ambiente (Com chaves padrão fornecidas)
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN", "8609947027:AAGhvNByUCfJgmpWzpol4OpxDDu4dtpFxn8")
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "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")
WEBHOOK_URL = os.getenv("WEBHOOK_URL")  # Essencial para rodar no Render
...
if __name__ == "__main__":
    # Quando rodando localmente (ex: Pydroid, VSCode)
    webhook_url = f"{WEBHOOK_URL}/{TELEGRAM_TOKEN}" if WEBHOOK_URL else ""
    ...
    if webhook_url:
        ...
        logger.warning("WEBHOOK_URL não definida! O bot só funcionará se o webhook já estiver setado.")
